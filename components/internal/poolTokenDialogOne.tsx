...
import { setPoolTokenDialogOneOpen} from "@/lib/redux/dialogState";
import { Search } from "lucide-react";
import { useDispatch, useSelector } from "react-redux";
import { Button } from "../ui/button";
import { Separator } from "@/components/ui/separator";
import { contractAddress } from "@/context/contractAddress";
import { setSelectedPoolTokenOneData} from "@/lib/redux/poolState";

const PoolTokenDialogOne = () => {
  ...
  return (
    <Dialog
      open={dialogState?.poolTokenDialogOneOpen}
...
export default PoolTokenDialogOne;
